...
const Post = ({ post }) => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`/post/${post._id}/${action}`, { withCredentials: true });
    ...
    const deletePostHandler = async () => {
        try {
            const res = await axios.delete(`/post/delete/${post?._id}`, { withCredentials: true })
            if (res.data.success) {
        ...
        <div className='my-8 w-full max-w-sm mx-auto '>
            <div className='flex items-center justify-between '>
                ...
                <Dialog>
                    ...
                    <DialogContent className="flex flex-col items-center text-sm text-center bg-gray-200">
                        {
